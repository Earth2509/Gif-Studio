...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../finalProjMai2.srcs/sources_1/ip/blk_mem_gen_1/sim/blk_mem_gen_1.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.blk_mem_gen_1 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.blk_mem_gen_1 -input simulate.do
}
# Script usage
usage()
{
